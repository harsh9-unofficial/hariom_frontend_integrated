...
const ProductModal = ({ isOpen, onClose, product, refreshProducts }) => {
  ...
  useEffect(() => {
    if (product) {
      ...
      setFormData({
        ...
        originalQty: product.originalQty || 1,
  ...
  const handleSubmit = async (e) => {
    ...
    formPayload.append("sub_cate_id", formData.sub_cate_id);
    ...
    formPayload.append("originalQty", formData.originalQty.toString());
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                className="w-full px-2 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#393185]"
                required
              >
            ...
            <div>
              ...
              >
                ...
                {subCateData
                  ?.filter(
                    (item) => item?.cate_id === parseFloat(formData.categoryId)
                  )
                  ?.map((category) => (
                    <option
                      key={category.sub_cate_id}
                      value={category.sub_cate_id}
                    >
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              <input
                ...
                className="flex-grow px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#393185]"
              />
              <button
                type="button"
                onClick={addFeature}
                className="px-4 py-2 bg-[#393185] text-white rounded-md cursor-pointer"
              >
                Add
              </button>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={handleInputChange}
                  className="h-5 w-5 text-[#393185] focus:ring-[#393185] border-gray-300 rounded"
                />
          ...
          <div>
            ...
            <input
              ...
              className="block text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-[#e6edff] file:text-[#393185] hover:file:bg-[#d1dfffda] file:cursor-pointer"
            />
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md text-white cursor-pointer ${
                isSubmitting ? "bg-[#8aa7ff]" : "bg-[#393185] "
              }`}
            >
