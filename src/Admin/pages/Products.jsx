        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
          <div className="relative flex-grow">
            <input
              ...
              className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#393185] cursor-pointer"
              value={searchTerm}
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-[#393185] text-white px-4 py-2 rounded-lg transition-colors cursor-pointer"
          >
